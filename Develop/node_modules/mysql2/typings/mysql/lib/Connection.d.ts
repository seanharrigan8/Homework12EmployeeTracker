...
import { Prepare, PrepareStatementInfo } from 'mysql2/typings/mysql/lib/protocol/sequences/Prepare.jsol/sequences/Prepare.js';
import {
  OkPacket,
  FieldPacket,
  RowDataPacket,
  ...
  OkPacketParams,
  ErrorPacketParams,
} from 'mysql2/typings/mysql/lib/protocol/packets/index.jsotocol/packets/index.js';
import { Connection as PromiseConnection } from 'mysql2/promise.js
import { AuthPlugin } from 'mysql2/typings/mysql/lib/Auth.jspings/mysql/lib/Auth.js';
import { QueryableBase } from 'mysql2/typings/mysql/lib/protocol/sequences/QueryableBase.jsuences/QueryableBase.js';
import { ExecutableBase } from 'mysql2/typings/mysql/lib/protocol/sequences/ExecutableBase.jsences/ExecutableBase.js';
